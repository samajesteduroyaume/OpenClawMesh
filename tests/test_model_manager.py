...
from openclaw_mesh.engines.model_manager import AutoModelManager
...
def test_model_manager_recommendations_for_different_vrams():
    ...
    low_hw = HardwareProfile(
        ...
        accelerator_type="cpu_generic",
        accelerator_name="Generic CPU",
    ...
    mid_hw = HardwareProfile(
        ...
        accelerator_type="apple_metal",
        accelerator_name="Apple Metal",
